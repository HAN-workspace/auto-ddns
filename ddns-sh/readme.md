...
### 必需文件：
- **[main.sh](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/main.sh)** 主脚本，判断公网IP是否发生变化的逻辑，读取配置，调用对应的 DNS 服务商API。如：aliyun.sh、cloudflare.sh
- **[aliyun.sh](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/aliyun.sh)** 与*阿里云*交互的 API 脚本，进行主机记录的增删改查操作
- **[cloudflare.sh](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/cloudflare.sh)** 与*cloudflare*交互的 API 脚本，进行主机记录的增删改查操作
- **[domain name](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/example.com.cn)** 配置文件 [参考示例](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#domain-%E5%86%85%E7%BB%93%E6%9E%84) 编写属于你的专用配置<br>
此文件名需用你的域名命名 ( *[example.com.cn](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/example.com.cn)* )
- **info.log** 记录：公网IP发生变化、向 *DNS 托管服务商* 交互时的错误信息、添新增子域名的操作也会记录
...
## domain 内结构：
共五个【section】: [【Auth】](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#auth) [【Direct】](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#direct) [【IPv6】](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#ipv6) [【IPv4】](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#ipv4) [【EnableCFproxied】](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#enablecfproxied)
### 配置示例：abc.com
```txt
[Auth]
...
[返回示例](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#domain-%E5%86%85%E7%BB%93%E6%9E%84)
