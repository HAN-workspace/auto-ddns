...
### 必需文件：
- **[main.sh](https://github.com/HAN-workspace/auto-ddns/blob/main/ddns-sh/main.sh)** 主脚本，判断公网IP是否发生变化的逻辑，读取配置，调用对应的域名托管商 DNS API。如：aliyun.sh、cloudflare.sh
...
- **[domain name](https://github.com/HAN-workspace/auto-ddns/blob/main/ddns-sh/example.com.cn)** 配置文件 [参考示例](https://github.com/HAN-workspace/auto-ddns/blob/CF-API/ddns-sh/readme.md#domain-%E5%86%85%E7%BB%93%E6%9E%84) 编写属于你的专用配置<br>
